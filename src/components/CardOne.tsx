    ...
    <div className="flex flex-col gap-[15px] lg:gap-3 w-full h-full border-primary rounded-[4px] p-[10px] lg:w-[280px] lg:p-[30px]">
      <div className="flex flex-col gap-3 flex-1 w-full h-full">
        ...
        <div className="flex flex-col w-full h-fit gap-[5px] lg:h-[92px]">
          ...
          <p className="text-green-500 font-medium text-[0.8125rem] leading-[15.85px] lg:text-[0.875rem] lg:leading-[17.07px]">
            {card.subTitle}
          </p>
          <p className="text-gray-500 font-medium text-[0.8125rem] leading-[15.85px] lg:text-[0.875rem] lg:leading-[17.07px]">
            {card.description}
          </p>
        </div>
      </div>
